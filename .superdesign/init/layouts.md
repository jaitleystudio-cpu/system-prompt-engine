...
The app has no router or framework layout API. `App` is the root shell and conditionally renders the home or workspace view. `Nav` is the persistent global header.

## `apps/web/src/layout/Nav.tsx`

Fixed global navigation with responsive disclosure and view/anchor navigation.
...
Root application shell. It owns engine orchestration, artifact/history/privacy state, shared navigation, home/workspace view switching, and the global footer.
