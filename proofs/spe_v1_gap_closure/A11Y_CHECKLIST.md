...
| pipeline_aria | **PASS** | SPE transforms messy human fragments into an idea, meaning, structure, and a perfect system prompt: IDEA, MEANING, SPE, STRUCTURE, PROMPT. |
| theme_keyboard_focus | **PASS** | theme toggle focusable |
| theme_aria | **PASS** | Theme: Dark (resolved dark). Activate to switch. |
| nav_real_links | **PASS** | /, /create, /code, /daily-lab, /my-work, /capabilities, /privacy, /create |
...
| reduced_motion_control | **PASS** | founder-art=1 animNone=true (Pause control removed; image hero) |
| zoom_200_usable | **PASS** | document roughly fits zoomed viewport heuristic |
| decorative_scene | **PASS** | {"canvases":0,"statics":1,"canvasOk":true,"staticOk":true} |
