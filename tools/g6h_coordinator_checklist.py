...
def main() -> int:
    ...
    print("  1. Open evaluations/g6zc/blind_evaluator.html")
    print("  2. Load evaluations/g6zc/blind_pairs.json")
    print("  3. Recruit real evaluators (pseudonymous E00x)")
    print("  4. Collect blinded ratings only (task + A/B + rubric)")
    print("  5. Preserve skips/invalids separately (skip ≠ tie)")
    print("  6. python tools/g6h_lock_ratings.py --ratings EXPORT.json \\")
    print("       [--skipped skips.json] [--invalid invalids.json] --expected 120")
    print("  7. ONLY AFTER LOCK:")
    ...
    print("  8. Adjudicate frozen thresholds → PASS/FAIL/INCOMPLETE/INVALID")
    print("  9. STOP — do not modify SPE")
    print()
    print("FORBIDDEN:")
